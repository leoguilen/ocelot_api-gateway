    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                host.MigrateDbContext<CustomerDbContext>(async (context, services) =>
                {
                    using var scope = services.CreateScope();

                    var logger = services.GetRequiredService<ILogger<CustomerDbContextSeed>>();

                    await CustomerDbContextSeed.SeedAsync(context, logger);
                });
